...
class ListMoviesControllerTest extends WebTestCase
{
    use FixturesTrait;
    ...
    /** @test */
    public function should_return_movies_list()
    {
        $this->client->request('GET', '/api/movies', ['page' => 1, 'limit' => 1, 'token' => $this->token]);
